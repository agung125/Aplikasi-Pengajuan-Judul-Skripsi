...
<head>
    ...
    <title>Dashboard &mdash; Pengajuan Skripsi</title>
        ...
        <div class="main-wrapper main-wrapper-1">
                ...
                <aside id="sidebar-wrapper">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="{{ setActive('admin/dashboard') }}"><a class="nav-link"
                                ...
                                @can('mahasiswas.index')
                                <li class="{{ setActive('admin/mahasiswa') }}"><a class="nav-link"
                                        href="{{ route('admin.mahasiswa.index') }}"><i class="fas fa-user-graduate"></i><span>Data Mahasiswa</span></a>
                                </li>
                                @endcan

                                @can('dosens.index')
                                <li class="{{ setActive('admin/dosen') }}"><a class="nav-link"
                                        href="{{ route('admin.dosen.index') }}"><i class="fas fa-user-tie"></i><span>Data Dosen</span></a>
                                </li>
                                @endcan

                                @can('skripsis.index')
                                <li class="{{ setActive('admin/skripsi') }}"><a class="nav-link"
                                        href="{{ route('admin.skripsi.index') }}"><i class="fas fa-journal-whills"></i><span>Pengajuan Skripsi</span></a>
                                </li>
                                @endcan

                                @can('dps.index')
                                <li class="{{ setActive('admin/dps') }}"><a class="nav-link"
                                        href="{{ route('admin.dps.index') }}"><i class="far fa-list-alt"></i><span>Dosen Pembimbing Skripsi</span></a>
                                </li>
                                @endcan
            ...
            <footer class="main-footer">
                <div class="footer-left">
                    Copyright &copy; 2018 <div class="bullet"></div> Pengajuan Skripsi <div class="bullet"></div> All Rights
                    Reserved.
                </div>
